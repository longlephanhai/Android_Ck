...
import com.example.ck_android.ui.screens.partfive.PartFiveItemScreen
import com.example.ck_android.ui.screens.partfive.PartFiveItemViewModel
import com.example.ck_android.ui.screens.partfive.PartFiveScreen
import com.example.ck_android.ui.screens.partfive.PartFiveViewModel
import com.example.ck_android.ui.screens.partfour.PartFourItemScreen
import com.example.ck_android.ui.screens.partfour.PartFourItemViewModel
...
import com.example.ck_android.ui.screens.partseven.PartSevenItemScreen
import com.example.ck_android.ui.screens.partseven.PartSevenItemViewModel
...
import com.example.ck_android.ui.screens.partsix.PartSixViewModel
...
sealed class Screen(val route: String) {
    ...
    object PartFourItem : Screen("part_four_item/{id}")
    object PartFive : Screen("part_five")
    ...
    object PartSevenItem : Screen("part_seven_item/{id}")
}
...
fun Navigation() {
    ...
    NavHost(navController = navController, startDestination = Screen.Start.route) {
        ...
        composable(
            ...
            PartFourItemScreen(
                navController = navController,
                partFourItemViewModel = hiltViewModel<PartFourItemViewModel>(),
                mainViewModel = mainViewModel,
                id = it.arguments?.getString("id") ?: "",
            )
        }
        composable(Screen.PartFive.route) {
            PartFiveScreen(
                navController = navController,
                partFiveViewModel = hiltViewModel<PartFiveViewModel>(),
                mainViewModel = mainViewModel
            )
        }
        composable(
            Screen.PartFiveItem.route,
            arguments = listOf(
                navArgument("id") { type = NavType.StringType },
            )
        ) {
            PartFiveItemScreen(
                navController = navController,
                partFiveItemViewModel = hiltViewModel<PartFiveItemViewModel>(),
                mainViewModel = mainViewModel,
                id = it.arguments?.getString("id") ?: "",
            )
        }
        composable(Screen.PartSix.route) {
            PartSixScreen(
                navController = navController,
                partSixViewModel = hiltViewModel<PartSixViewModel>(),
                mainViewModel = mainViewModel
            )
        }
        composable(
            Screen.PartSixItem.route,
            arguments = listOf(
                navArgument("id") { type = NavType.StringType },
            )
        ) {
        ...
        composable(
            ...
            PartSevenItemScreen(
                navController = navController,
                partSevenItemViewModel = hiltViewModel<PartSevenItemViewModel>(),
                mainViewModel = mainViewModel,
                id = it.arguments?.getString("id") ?: "",
            )
        }
