...
class ApiServiceImpl @Inject constructor(
    ...
    override suspend fun getPartFiveTitle(access_token: String): PartFiveResponse {
        return apiClient.apiService.getPartFiveTitle(access_token)
    }

    override suspend fun getQuestionPartFive(
        access_token: String,
        id: String
    ...
    override suspend fun getQuestionPartSix(
        access_token: String,
        id: String
    ): PartSixQuestionResponse {
        return apiClient.apiService.getQuestionPartSix(access_token, id)
    }

    override suspend fun getPartSevenTitle(access_token: String): PartSevenResponse {
        return apiClient.apiService.getPartSevenTitle(access_token)
    }

    override suspend fun getQuestionPartSeven(
        access_token: String,
        id: String
    ): PartSevenQuestionResponse {
        return apiClient.apiService.getQuestionPartSeven(access_token, id)
    }
