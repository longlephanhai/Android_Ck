...
@HiltViewModel
class PartSixViewModel @Inject constructor(
    private val apiService: ApiService,
    private val mainLog: MainLog,
    private val dataStoreManager: DataStoreManager
) : ViewModel() {
    val _uiState = MutableStateFlow(PartSixResponse())
    ...
    fun getPartSixTitle() {
        viewModelScope.launch {
            ...
            try {
                ...
                val response = requireNotNull(apiService).getPartSixTitle("Bearer $accessToken")
