...
@HiltViewModel
class PartFourItemViewModel @Inject constructor(
    private val apiService: ApiService,
    private val mainLog: MainLog,
    private val dataStoreManager: DataStoreManager,
) : ViewModel() {
    val _uiState = MutableStateFlow(PartFourQuestionResponse())
    ...
    fun getPartOneQuestion(id: String) {
        viewModelScope.launch {
            ...
            try {
                ...
                val response =
                    requireNotNull(apiService).getQuestionPartFour("Bearer $accessToken", id)
