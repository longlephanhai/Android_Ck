...
fun PartThreeScreen(
    ...
    partThreeViewModel: PartThreeViewModel,
    mainViewModel: MainViewModel
) {
    val uiState = partThreeViewModel.uiState.collectAsState()
    LaunchedEffect(Unit) {
        partThreeViewModel.getPartThreeTitle()
    }
                    ...
                    Row(
                        ...
                        Button(
                            onClick = {
                                ...
                                navController.navigate("part_three_item/${item._id}")
                            },
                            modifier = Modifier
                                .weight(0.2f)
                                .height(40.dp),
