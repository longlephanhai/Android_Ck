...
@Composable
fun PartFiveItemScreen(
    navController: NavController,
    partFiveItemViewModel: PartFiveItemViewModel,
    ...
    val questionData = partFiveItemViewModel.uiState.collectAsState()

    LaunchedEffect(Unit) {
        partFiveItemViewModel.getPartFiveQuestion(id)
    }
