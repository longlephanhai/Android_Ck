...
@HiltViewModel
class PartOneViewModel @Inject constructor(
    private val apiService: ApiService,
    private val mainLog: MainLog,
    private val dataStoreManager: DataStoreManager
) : ViewModel() {
    val _uiState = MutableStateFlow(PartOneResponse())
    ...
    fun getPartOneTitle() {
        viewModelScope.launch {
            ...
            try {
                ...
                val response = requireNotNull(apiService).getPartOneTitle("Bearer $accessToken")
